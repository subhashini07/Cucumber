...
public class RegisterDetails {
	...
	public void user_is_in_demo_site() {
		System.setProperty("webdriver.chrome.driver",
				"C:\\Users\\SureshG\\subhaworkspace\\CumDemo\\Dri\\chromedriver.exe");
		driver = new ChromeDriver();
		driver.get("http://demo.automationtesting.in/Register.html");
	}

	@When("User enters the {string},{string},{string},{string},{string},{string},{string} and then click and submit")
	public void user_enters_the_and_then_click_and_submit(String firstName, String lastName, String address,
			String emailAddress, String phone, String passWord, String confirmPassword) {
		...
		sub.click();
		WebElement lstnum = driver.findElement(By.xpath("//a[text()='WebTable']"));
		lstnum.click();
